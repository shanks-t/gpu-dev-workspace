...
1. **RTX 3090 on RunPod Community** is the default CUDA lab. It provides 24 GB at the lowest current target price and matches the existing Terraform default.
...
| --- | --- | ---: | --- | ---: | ---: | --- |
| `n1-standard-4` + 1 T4 | Turing T4 | 16 GB | 4 vCPU, 15 GiB | $0.539999 | $0.279680 | Current fallback |
