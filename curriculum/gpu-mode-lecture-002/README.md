...
Please make sure PyTorch (2.1.2) and cuda-toolkit (nvcc compiler) are installed.
  - [CUDA Grid Explorer](../../learning-tools/cuda-grid-explorer/) — interactive visualization of CUDA grids, blocks, threads, indexing, launch coverage, and row-major array layouts. Open `index.html` locally.
